...
//                anchors.fill: _image
//                source: _image
//                color: control.checked ? NemacUI.Theme.highlightedTextColor : NemacUI.Theme.disabledTextColor
//            }
        }
        ...
        Label {
            id: _label
            color: control.checked ? NemacUI.Theme.highlightedTextColor : NemacUI.Theme.textColor
