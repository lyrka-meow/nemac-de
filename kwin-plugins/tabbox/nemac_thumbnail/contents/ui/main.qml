...
KWin.Switcher {
    ...
    Window {
        ...
        Rectangle {
            ...
            opacity: windowHelper.compositing ? NemacUI.Theme.darkMode ? 0.3 : 0.4 : 1.0

            border.color: NemacUI.Theme.darkMode ? "#686868" : "#D9D9D9"
                ...
                delegate: Item {
                    ...
                    ColumnLayout {
                        ...
                        Label {
                            ...
                            color: isCurrent ? NemacUI.Theme.highlightedTextColor : NemacUI.Theme.textColor
                        }
                    }
                } // GridView.delegate
