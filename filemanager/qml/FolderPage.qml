...
import Nemac.FileManager 1.0 as FM
...
Item {
    ...
    NemacUI.AboutDialog {
        ...
        description: qsTr("A file manager designed for NemacDE.")
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            height: NemacUI.Theme.mediumRadius
            width: NemacUI.Theme.mediumRadius
            color: NemacUI.Theme.secondBackgroundColor
        }
...
//        }
    ...
    Component {
        ...
        FolderListView {
            ...
            topMargin: NemacUI.Units.smallSpacing
