...
import Nemac.DragDrop 1.0 as DragDrop
...
ListView {
    ...
    property var itemHeight: NemacUI.Units.fontMetrics.height * 2 + NemacUI.Units.smallSpacing
        ...
        TextField {
            ...
            onTargetItemChanged: {
                if (targetItem != null) {
                    ...
                    height = NemacUI.Units.fontMetrics.height + NemacUI.Units.largeSpacing * 2
