...
Window {
    ...
    maximumHeight: _mainLayout.implicitHeight + NemacUI.Units.largeSpacing * 4
    maximumWidth: 400
    minimumWidth: 400
    minimumHeight: _mainLayout.implicitHeight + NemacUI.Units.largeSpacing * 4
    ...
    GridLayout {
        ...
        rowSpacing: NemacUI.Units.largeSpacing * 2
