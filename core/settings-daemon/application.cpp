...
//    , m_kwinTimer(new QTimer(this))
{
    ...
    QDBusConnection::sessionBus().registerService(QStringLiteral("com.nemac.Settings"));
...
//    m_kwinTimer->start();
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/nemac-settings-daemon/translations/").arg(locale.name());
...
void Application::invokeDesktopProcess()
{
    ...
    QDBusInterface sessionInterface("com.nemac.Session", "/Session", "com.nemac.Session",
...
//        effect.call("loadEffect", "nemac_popups");
//        effect.call("loadEffect", "nemac_scale");
//        effect.call("loadEffect", "nemac_squash");
