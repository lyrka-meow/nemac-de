/*
    SPDX-FileCopyrightText: 2021 Reion Wong <reion@nemacde.com>
...
Item {
    ...
    property int popupEdgeDistance: NemacUI.Units.largeSpacing
    property int popupSpacing: NemacUI.Units.largeSpacing
