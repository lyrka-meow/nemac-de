    ...
    Scrollable {
        ...
        ColumnLayout {
            ...
            BatteryItem {
                ...
                ColumnLayout {
                    anchors.fill: parent
                    anchors.leftMargin: batteryBackground.radius + NemacUI.Units.smallSpacing
            ...
            RoundedItem {
                ...
                RowLayout {
                    Layout.topMargin: NemacUI.Units.largeSpacing
                    spacing: NemacUI.Units.largeSpacing * 4

                    // Poor
                    Item {
                        height: _poorLabel.implicitHeight + 4 + NemacUI.Units.smallSpacing
                        width: _poorLabel.implicitWidth + NemacUI.Units.largeSpacing
                    ...
                    Item {
                        height: _normalLabel.implicitHeight + 4 + NemacUI.Units.smallSpacing
                        width: _normalLabel.implicitWidth + NemacUI.Units.largeSpacing
                    ...
                    Item {
                        height: _excellentLabel.implicitHeight + 4 + NemacUI.Units.smallSpacing
                        width: _excellentLabel.implicitWidth + NemacUI.Units.largeSpacing
