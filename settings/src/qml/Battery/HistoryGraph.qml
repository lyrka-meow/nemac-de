...
Canvas {
    ...
    property bool darkMode: NemacUI.Theme.darkMode
    property color textColor: NemacUI.Theme.textColor
    property color bgColor: NemacUI.Theme.secondBackgroundColor
    property color highlightColor: NemacUI.Theme.highlightColor
...
//        c.rect(xPadding - 1, yPadding - 1, plotWidth + 2, plotHeight + 2);
        ...
        c.textAlign = "center"
        c.lineWidth = 1
        c.strokeStyle = NemacUI.Theme.darkMode ? 'rgba(0, 0, 0, 0.35)' : 'rgba(0, 0, 0, 0.15)'
