...
Item {
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Layout.preferredHeight: _topItem.implicitHeight + NemacUI.Units.largeSpacing
...
//                    }
            ...
            RowLayout {
                ...
                Image {
                    ...
                    source: "qrc:/images/" + (NemacUI.Theme.darkMode ? "dark/" : "light/") + model.connectionIcon + ".svg"
                    smooth: false
                }
                ...
                Image {
                    ...
                    height: width
                    sourceSize: Qt.size(width, height)
                    source: NemacUI.Theme.darkMode ? "qrc:/images/dark/locked.svg" : "qrc:/images/light/locked.svg"
