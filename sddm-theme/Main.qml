...
Item {
    ...
    Image {
        id: wallpaperImage
        anchors.fill: parent
        source: "file://" + "/usr/share/backgrounds/nemacde/default.jpg"
    ...
    Item {
        ...
        width: 260 + NemacUI.Units.largeSpacing * 3
    ...
    Item {
        ...
        width: sessionMenu.implicitWidth + NemacUI.Units.largeSpacing
    ...
    Item {
        ...
        anchors.bottomMargin: NemacUI.Units.smallSpacing * 1.5

        width: 50
        height: 50 + NemacUI.Units.largeSpacing


        NemacUI.RoundImageButton {
            anchors.fill: parent
            width: 50
            height: 50 + NemacUI.Units.largeSpacing
