...
{
    QSettings settings(QSettings::UserScope, "nemacde", "dock_pinned");
    QSettings systemSettings("/etc/nemac-dock-list.conf", QSettings::IniFormat);
    ...
    // Launcher
    ApplicationItem *item = new ApplicationItem;
    item->id = "nemac-launcher";
    item->exec = "nemac-launcher";
