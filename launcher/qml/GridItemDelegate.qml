...
Item {
    ...
    IconItem {
        ...
        anchors.margins: NemacUI.Units.largeSpacing * 2
    ...
    MouseArea {
        ...
        onClicked: {
            if (mouse.button == Qt.LeftButton)
                ...
                uninstallItem.visible = appManager.isNemacDE()
    ...
    Label {
        ...
        anchors {
            ...
            margins: NemacUI.Units.smallSpacing
        }
        ...
        width: parent.width - 2 * NemacUI.Units.smallSpacing
