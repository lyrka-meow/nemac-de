...
#define DBUS_NAME "com.nemac.Launcher"
#define DBUS_PATH "/Launcher"
#define DBUS_INTERFACE "com.nemac.Launcher"

int main(int argc, char *argv[])
{
    QCoreApplication::setAttribute(Qt::AA_EnableHighDpiScaling);

    QByteArray uri = "Nemac.Launcher";
    ...
    app.setApplicationName(QStringLiteral("nemac-launcher"));
    ...
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/nemac-launcher/translations/").arg(locale.name());
