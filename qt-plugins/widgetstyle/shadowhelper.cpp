...
const char netWMSkipShadow[] = "_NEMAC_NET_WM_SKIP_SHADOW";
const char netWMForceShadow[] = "_NEMAC_NET_WM_FORCE_SHADOW";
const char netWMFrameRadius[] = "_NEMAC_NET_WM_FRAME_RADIUS";
